...
CREATE TABLE "Ship" (
    ...
    "locator" DOUBLE PRECISION NOT NULL DEFAULT 3,
    "fuel" DOUBLE PRECISION NOT NULL DEFAULT 100,
    "fuelCapacity" DOUBLE PRECISION NOT NULL DEFAULT 100,
    "fuelPerUnit" DOUBLE PRECISION NOT NULL DEFAULT 0.01,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "PlanetVisit" ADD CONSTRAINT "PlanetVisit_uid_fkey" FOREIGN KEY ("uid") REFERENCES "GameData"("uid") ON DELETE RESTRICT ON UPDATE CASCADE;
